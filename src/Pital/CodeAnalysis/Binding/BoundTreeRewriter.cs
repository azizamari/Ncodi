...
namespace Ncodi.CodeAnalysis.Binding
{
    internal abstract class BoundTreeRewriter
    {
        ...
        protected virtual BoundStatement RewriteDoWhileStatement(BoundDoWhileStatement node)
        {
            ...
            return new BoundDoWhileStatement(body, condition,node.BreakLabel, node.BreakLabel);
        }
        ...
        protected virtual BoundStatement RewriteWhileStatement(BoundWhileStatement node)
        {
            ...
            return new BoundWhileStatement(condition, body, node.BreakLabel, node.BreakLabel);
        }
        ...
        protected virtual BoundStatement RewriteForStatement(BoundForStatement node)
        {
            ...
            return new BoundForStatement(node.Variable, lowerBound, upperBound, body, node.BreakLabel,node.BreakLabel);
        }
